...
3. In the NIOS Grid Manager, navigate to *Infoblox* *Grid Properties Editor *> **Infoblox Portal** **Configuration** and add a join token. The join token authenticates a virtual DNS forwarding proxy to establish a connection with the Infoblox Portal Configuration. For more information on creating a join token, see [*Using Forwarders*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/317784896).  
