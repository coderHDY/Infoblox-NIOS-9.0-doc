...
**IPv4** **DHCP** **Options/IPv6** **DHCP** **Options**: DHCP options provide specific configuration and service information to DHCP clients. For more information, see [*About IPv4 DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271370).  
