...
4. **TCP Scan Technique**: Select the TCP technique you want to use for the discovery. The default is **SYN**. For more information, see [*TCP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666366)*.*
