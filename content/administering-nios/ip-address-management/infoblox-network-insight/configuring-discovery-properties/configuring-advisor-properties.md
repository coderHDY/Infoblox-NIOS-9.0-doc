...
pageId: "1343293033"
---
For information about Advisor, see [*Monitoring Device Lifecycle and Vulnerabilities Using Advisor*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273078).
...
- You have a local DNS resolver working on the discovery node. For more information, see [*Enabling DNS Resolution*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280764908)*.*
