...
6. Optionally, you can test the credentials you added to the list. You can test SNMPv1/v2c and SNMPv3 credentials against any device or any IP address, at the Grid level or from any Probe member or network view. For more information, see Testing SNMP and CLI Credentials below[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406248/Configuring+Discovery+Properties#bookmark1421)
