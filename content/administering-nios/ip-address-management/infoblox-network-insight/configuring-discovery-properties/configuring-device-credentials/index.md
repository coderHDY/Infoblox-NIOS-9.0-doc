...
If any SNMP or CLI credentials become obsolete, you can reset them for all affected devices at once. After that, Network Insight re-guesses the credentials for each device. This does not apply to CLI credentials manually set for specific devices. For more information, see the [*reset snmp*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/154763367) and [*reset cli*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280855985)* *Administrative Shell commands.
