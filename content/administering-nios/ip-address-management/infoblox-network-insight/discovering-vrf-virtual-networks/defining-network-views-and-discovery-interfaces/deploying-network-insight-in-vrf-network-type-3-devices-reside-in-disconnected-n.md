...
- The discovered VRF instances must be associated with the network views to which they belong. For more information, see [*Viewing Discovered VRFs and Mapping Network Views*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273310/Viewing+Discovered+Devices+and+their+Properties#https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273310/Viewing+Discovered+Devices+and+their+Properties/#VDVMNV).
