...
- You can use filters to narrow down the list. You can filter the list based on the VRF name, Device name, Device IP address, and network view. For more information, see [*Using Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280401588).
