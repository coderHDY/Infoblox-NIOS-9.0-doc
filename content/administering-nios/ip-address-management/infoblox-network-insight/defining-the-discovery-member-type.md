...
To change the interface over which a member sends and receives discovery traffic, see [*Mapping Discovery Interfaces to Network Views*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406313).
