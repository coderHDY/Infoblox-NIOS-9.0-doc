...
pageId: "280406370"
---
You can start a discovery and manage discovered data based on your administrative permissions. For more information, see [*About Administrative Permissions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280275424).  
...
For more information on configuring admin user accounts and working with permissions, see the sections under [*Managing Administrators*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280268091). For information about discovery permissions, see [*Administrative Permissions for Network Discovery*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280668320/Administrative+Permission+for+the+Grid#APND).
