...
For details on what data is collected and where it appears in the UI, see section [*Data Collection and Populated Information*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/317424877/Configuring+Discovery+for+SDN+and+SD-WAN#Data-Collection-and-Populated-Information) in [*Configuring Discovery for SDN and SD-WAN*](administering-nios/ip-address-management/infoblox-network-insight/configuring-discovery-for-sdn-and-sd-wan).
