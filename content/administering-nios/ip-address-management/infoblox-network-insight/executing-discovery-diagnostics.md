...
> ### Note
> 
> An Unmanaged IP cannot be converted to Managed unless the network that contains it, is converted to managed status. For more information, see [*Converting Unmanaged Networks under IPAM to Managed Status*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1432786191).
