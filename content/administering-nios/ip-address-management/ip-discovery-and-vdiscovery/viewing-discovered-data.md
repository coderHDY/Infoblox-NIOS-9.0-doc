...
pageId: "280666433"
---
After an IP discovery and a vDiscovery, you can view discovered data in the Discovered Data section when you drill down to a specific IP address in the Net Map, Net List, IP Map or IP List panel. For information about IP Map and IP List, see [*Viewing and Managing IPv4 Addresses*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666616)*.*  
...
To view discovered data for cloud VMs, see [*Viewing All Cloud VMs*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1356824724).
