---
title: "Defining IP Discovery Method"
source: "/space/nios90/1330872644"
pageId: "1330872644"
---
...
2. In the *Discovery* *Manager* wizard, click the **IPv4** **Device** **Discovery** tab, and then complete the following in the **Basic** tab:
   ...
   - **Mode**: Select the IP discovery method you want to use. For information, see [*Supported IP Discovery Methods*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273625)[  ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273625). If you select **TCP** or **FULL**, ensure that you configure the TCP ports in the **Advanced** tab. The default is **FULL**.
   - Click the Add icon to add networks. In the *Network* *Selector* dialog box, select the network view and networks. Use SHIFT+click and CTRL+click to select multiple networks. You can also use filters or the Go to function to find a specific network. For information, see [*Using Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/500861569) and [*Using the Go To Function*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/500861569).  
...
3. If you select **TCP** or **FULL** in **Mode**, click the **Advanced** tab and complete the following:
   ...
   - **TCP** **Scan** **Technique**: Select the TCP technique you want to use for the discovery. The default is SYN. For information, see [*TCP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273625).
...
- View the discovery status. You can view the current discovery status in the *Discovery* *Status* widget on the Dashboard. For information, see [*Dashboards*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280266914).
- View the discovered data. For information, see [  ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[*Viewing*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[   ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[*Discovered*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[   ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[*Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433)
- Manage the discovered data. For information, see [  ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[*Managing*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[   ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[*Discovered*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[   ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[*Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406620)
