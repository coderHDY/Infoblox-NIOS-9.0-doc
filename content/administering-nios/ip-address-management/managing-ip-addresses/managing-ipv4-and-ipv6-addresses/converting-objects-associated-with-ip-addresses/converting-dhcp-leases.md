...
4. For all IPv4 conversions, Grid Manager populates the discovered information in the corresponding editor. Depending on the type of conversion, do one of the following:
   ...
   - For host record conversions, see [*About Host Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666779).
   - For IPv4 reservation conversions, see [*Modifying IPv4 Reservations*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280404203).
   - For fixed address conversions, see [*Modifying IPv4 Fixed Addresses*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271095)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271095/Configuring+IPv4+Fixed+Addresses#ModifyingIPv4FixedAddresses)
   - For A record conversions, see [*Modifying A Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762656)*.*
   - For PTR record conversions, see [*Modifying PTR Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762656).
