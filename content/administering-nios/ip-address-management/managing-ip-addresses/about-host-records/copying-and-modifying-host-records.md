...
4. The *Host* *Record* editor provides the following tabs from which you can modify all the fields:
   ...
   - **IPv4 ** **Discovered** ** Data:** Displays the discovered data of the IPv4 addresses, if any, of the host record. For information, see [*Viewing Discovered Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433).
   - **Port** ** Reservation**: Review and edit any device port reservations that may be defined for the current object, or create a new port reservation and schedule it. For a closer look, see the section [*Port Control Features in Network Insight*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666028), and steps 4-8 in the section  Adding Host Records above.
   - **IPv6** **Discovered** **Data:** Displays the discovered data of the IPv6 addresses, if any, of the host record. For information, see [*Viewing Discovered Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433).
   - **Extensible** ** Attributes:** You can add and delete extensible attributes that are associated with a host record. You can also modify the values of extensible attributes. For information, see [*Managing Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
