...
- Use the identity mapping feature to get visibility of user interaction with their environments. For information, see [*Configuring Identity Mapping*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280761172).
...
For information about the displayed status, see [*Viewing DNS and DHCP Service Status on Microsoft Servers*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280761116).
...
You can configure an output destination for Microsoft server log messages at the Grid level and override it at the Microsoft server level. You can choose to save log messages related to Microsoft synchronization in the syslog or Microsoft log. For information, see [*Viewing the Syslog*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403148).  
