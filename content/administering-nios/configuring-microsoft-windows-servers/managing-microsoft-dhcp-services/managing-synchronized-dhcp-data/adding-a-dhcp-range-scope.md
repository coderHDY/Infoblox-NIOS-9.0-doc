...
pageId: "1467056332"
---
After you add a network for a scope, you must then define its DHCP range. You can create the DHCP range from scratch or use a DHCP Range template. For information about DHCP templates, see [About IPv4 Range Templates](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280404118).  
