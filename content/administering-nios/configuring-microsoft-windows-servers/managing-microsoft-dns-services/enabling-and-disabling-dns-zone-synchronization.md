...
3. Select **Use** **this** **set** **of** **name** **servers**, and enter the details as specified in *[Assigning Zone Authority to Name Servers](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272599)*.
