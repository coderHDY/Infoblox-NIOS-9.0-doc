...
1. Create a local RPZ by completing the procedure described in [*Configuring Local RPZs*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760177).
