...
You can use this feature when you have Infoblox Threat Defense Business On-premises, Infoblox Threat Defense Business Cloud, or Infoblox Threat Defense Advanced license. Note that you can configure only one cloud client per on-premises Grid. Ensure that you configure the email address and password in the *Grid Properties* *Editor* before you enable the integration with Infoblox Threat Defense Cloud Client. For more information about Configuring Integration with Infoblox Threat Defense Cloud, see [*Configuring Integration with Infoblox Threat Infoblox Cloud*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280759852).
