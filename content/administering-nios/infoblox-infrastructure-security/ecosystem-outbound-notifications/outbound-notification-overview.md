...
2. Create necessary extensible attributes, if required. For more information, see *[Managing Extensible Attributes](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215)*.
...
5. Add an endpoint. You can either add REST API or DXL endpoints. For DXL endpoints, you must generate a NIOS client certificate, import DXL certificates and import or add list of DXL brokers. For more information, see *[Configuring Outbound Endpoints](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280269512)*.
6. Define notification rules. For more information, see *[Configuring Notification Rules](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280759890)*.
...
For information about how to install licenses, see *[Managing Licenses in NIOS 9.0.1 and Later](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/318670359)*.
