...
3. Click **Add** to add an outbound template. To add a session management template, see [*Creating Session Management Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280759926) or [*Creating Action Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280402383) to create an action template.
4. Optionally, click **View Results** to open the *Syslog Preview* dialog and view all the syslog messages. For more information, see [*Previewing Syslog Events*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/537002114).
