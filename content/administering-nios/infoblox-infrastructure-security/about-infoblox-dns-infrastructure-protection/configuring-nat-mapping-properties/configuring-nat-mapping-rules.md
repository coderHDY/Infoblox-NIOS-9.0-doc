...
> **Note**
> 
> If you change the NAT Mapping rule after you have configured the NAT Mapping rule or if you enable or disable the NAT Mapping feature, you must publish the changes by clicking **Publish** **Changes** from the Toolbar. For information, see *[Publishing Rule Updates](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280408857)*.
