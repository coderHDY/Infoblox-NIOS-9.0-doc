...
1. From the **Data ****Management** tab, select the **Security** tab, and then click the **Profiles** tab. Grid Manager displays the following information:
   ...
   - **Name**: The name of the DNS Infrastructure Protection profile. Click the *profile* name to view the rules that are associated with the selected DNS Infrastructure Protection profile. For more information about rules, see *[Viewing DNS Infrastructure Protection Rulesets](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280668850)*.
...
- Use **Global** **Search** to search for DNS Infrastructure Protection profiles by name, comment or object type. For information, see *[Using Global Search](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280401588)*.
