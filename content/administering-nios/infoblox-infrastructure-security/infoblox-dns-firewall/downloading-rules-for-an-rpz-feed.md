...
After you have downloaded rules from an RPZ feed, you can test RPZ feed policies, as described in *[Testing RPZ Feed Rules](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760150)*.
