...
- For the Grid or member, see *[Enabling Recursive Queries](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280665882)*.
- For a DNS view, see *[Managing Recursive DNS Views](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280665456)**.*
...
3. Select **All** **Recursive** **Name** **Servers** from the list to add all the recursive name servers in the Grid as the secondary name servers for the corresponding zone.
   ...
   - Save the configuration and click **Next** to define extensible attributes. Click **Restart** if it appears at the top of the screen. For information about extensible attributes, see *[Managing Extensible Attributes](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215)*.
