...
3. In the **Notification** **Settings** page, click the **http** link and then enter the name of the HTTP server you want to add. Click **Add** **HTTP** **Server** and complete the following:
   ...
   - **Username** **and** **Password**: Enter the Username and Password of the user that you have configured for the **fireeye-group** on the NIOS appliance. For more information, see [*For FireEye Integrated RPZs*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/420544897).
