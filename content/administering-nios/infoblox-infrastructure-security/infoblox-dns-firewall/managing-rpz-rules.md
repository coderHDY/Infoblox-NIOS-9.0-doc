...
- Click the *Print* icon to print the list of RPZ rules. For more information, see *[Printing from Grid Manager](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/500861569)*.
...
2. The RPZ rules editor provides the following tabs from which you can modify data:
   ...
   - In the **General** tab, you can change the information you previously entered through the wizard. For more information, see *[Configuring Rules for RPZs](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280269891)*.
   - You can also enter or edit information in the **TTL** **and** **Extensible** **Attributes** tabs. For information about TTL settings, see *[Specifying Time To Live Settings](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/281215163)*. For information about extensible attributes, see *[Managing Extensible Attributes](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215)*.
...
2. To delete an RPZ rule immediately, click the *Delete* icon, and then click **Yes** to confirm the delete request. To schedule the deletion, click **Schedule** **Deletion** and in the **Schedule** **Change** panel, enter a date, time, and time zone. For information, see [*Scheduling*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/504168883/Scheduling+New+IPAM+DHCP+Objects+and+Associated+Port+Configurations#bookmark145)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/504168883/Scheduling+New+IPAM+DHCP+Objects+and+Associated+Port+Configurations#bookmark145)[*Deletions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/504168883/Scheduling+New+IPAM+DHCP+Objects+and+Associated+Port+Configurations#bookmark145).
