...
2. Click **Add** and enter the usernames and passwords. For more information on how to add users to an admin group, see [*Creating Local Admins*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280766011). Select **fireeye-group** for the admin group and add users to this group.
