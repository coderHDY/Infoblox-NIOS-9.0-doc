...
You can also create [smart folders](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280757969) and obtain a list of networks by the assigned VLAN ID or name.
...
5. From the **VLAN Parent Type** drop-down list, select the parent type of the VLAN object that you want to add. The parent type can either be a VLAN view or a VLAN range. For more information, see *[Configuring VLANs](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280400602)*.
...
You can also assign a VLAN object when creating an IPv4 or IPv6 network. For more information, see *[Configuring IPv4 Networks](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280761742)* and *[Managing IPv6 Networks](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/319292098)*.
