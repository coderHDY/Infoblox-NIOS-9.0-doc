...
You can configure the group-by-extensible-attribute filter and data calculation methods for the following dashboards only. For more information about these dashboards, see [*Predefined Dashboards*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280758557)*.*
