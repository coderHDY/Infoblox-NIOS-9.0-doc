...
- **Lease IP**: The IP address of the lease. You can click the lease IP address to view login details of the user. For information about *User* *History* *for* *Lease* *IP* sub-report, see [*Security Dashboards*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760447). You can also view subscription data for the selected lease IP. For information about Subscription Data, see [*Ecosystem Dashboards*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270217).
