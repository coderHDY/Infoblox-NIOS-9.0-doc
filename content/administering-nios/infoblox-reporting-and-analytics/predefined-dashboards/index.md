...
| --- | --- | --- |
| **Audit** **Log** **Events** | See the following dashboard categories at *[Audit Log Events Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280402856)* |  |
|  | For Audit Log Events | Yes |
|  | For Audit Log WAPI Events | Yes |
| I**PAMv4** **Utilization** | See the following dashboard categories at *[IPAMv4 Utilization Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280402831)*: |  |
...
| **Devices** **(Discovery)** | See the following dashboard categories at *[Devices (Discovery) Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280662425)*: |  |
...
|  | Device Advisor | Yes |
| **DHCP** **Dashboards** | See the following dashboard categories at *[DHCP Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270189)**:* |  |
...
| **DNS** **Dashboards** | See the following dashboard categories at *[DNS Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760429)* |  |
...
| **Security** **Dashboards** | See the following dashboard categories at *[Security Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760447)* |  |
|  | FireEye Alerts | Yes |
...
| **Ecosystem** **Dashboards** | See the following dashboard categories at *[Ecosystem Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270217)* |  |
|  | User Login History Report | Yes |
|  | Subscription Data | Yes |
|  | Publish Data | Yes |
| **Cloud** **Dashboards** | *[VM Address History](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280402874)* | Yes |
| **System** **Utilization** | See the following dashboard categories at *[System Utilization Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270234)* |  |
...
| **Internal** **Dashboards** | See the following dashboard categories at *[Internal Dashboards](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270248)* |  |
...
| License Dashboards | *[License Pool Utilization](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280662404)* | No |
