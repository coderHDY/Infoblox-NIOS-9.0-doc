...
pageId: "1366983702"
---
To selectively delete reporting data from NIOS, you must first enable the `delete` permission for the local admin with superuser permission by using the [*set reporting_user_capabilities*](/wiki/spaces/nios90draft/pages/73297770) command in the NIOS CLI. Then, complete the following:
