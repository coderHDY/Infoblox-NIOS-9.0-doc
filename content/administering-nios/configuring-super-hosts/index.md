...
You can group super host objects in smart folders according to their attributes. For example, you can create a smart folder that contains all records in a specific super host. For more information, see [*Smart Folders*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280757969). Use Capacity Report to view the total capacity utilization of super host objects. For more information, see [*Using the Capacity Report*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403049).
