...
2. The *DHCP* *Failover* *Association* editor contains the following tabs from which you can modify data:
   ...
   - **General**: In the **Basic** tab, modify the fields as described in [*Adding Failover Associations*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663427)*.*  
   ...
   - **Failover Settings:** This is valid for Microsoft Management only. For information about the fields in the **Basic** tab, see [*Configuring Failover Associations*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663427).  
   ...
   - **Extensible** **Attributes**: Add and delete extensible attributes that are associated with a failover association. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
