...
You can run the *Captive* *Portal* wizard to automatically create the MAC address filters, as described in the next section, *[Using the Captive Portal Wizard](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663106)*, or you can configure each filter as described in *[Defining MAC Address Filters](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403799)*.
