...
3. In the *Option* *Space* wizard, do the following:
   ...
   - **Options**: Click the Add icon to add options. For additional information, see the next section,* *[*Configuring Custom DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271370/About+IPv4+DHCP+Options#Configuring-Custom-DHCP-Options).
4. Save the configuration and click **Restart** if it appears at the top of the screen.

After you create an option space and add options to it, you can apply the options as described in* *[*Applying DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271370/About+IPv4+DHCP+Options#Applying-DHCP-Options)* *below.
