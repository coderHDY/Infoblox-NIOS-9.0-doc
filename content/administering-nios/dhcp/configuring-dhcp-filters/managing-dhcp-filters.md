...
2. For a MAC address filter, the *DHCP* *MAC* *Filter* editor provides the following tabs from which you can modify information:
   ...
   - **General**: Modify the fields as described in [*Defining MAC Address Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403799).
   - **DHCP** **Options**: Add or delete DHCP options. For information, see [*Defining MAC Address Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403799).
   - **Extensible** **Attributes**: Add or delete extensible attributes that are associated with a specific DHCP range. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
...
- For a relay agent filter, the Relay Agent Filter editor provides the following tabs from which you can modify information:
  ...
  - **General**: Modify the fields as described in [*Defining Relay Agent Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280761466).
  - **Extensible** **Attributes**: Add and delete extensible attributes that are associated with a specific DHCP range. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).

- For an option filter, the Option Filter editor contains the following tabs from which you can modify information:
  
  - **General**: Modify the fields as described in [*Defining Option Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403707).
  - **Rules**: Modify the match rules as described in [*Defining Option Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403707).
  - **DHCP Options**: Modify option spaces and DHCP options in the **Basic** tab as described in [*Defining Option Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403707). You must define the **PXE Lease Time** in the **Advanced** tab.
  - **BOOTP**: Modify BOOTP settings as described in [*Configuring IPv4 BOOTP and PXE Properties*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663785).
  - **Extensible Attributes**: Add or delete extensible attributes that are associated with a specific DHCP range. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
...
- For a DHCP fingerprint filter, the Add IPv4 Fingerprint Filter editor provides the following tabs from which you can modify information:
  ...
  - **General**: Modify general information, such as the name and device class, as described in [*Defining DHCP Fingerprint Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663241)*.*
  - **Fingerprints**: Add or delete DHCP fingerprints as described in [*Defining DHCP Fingerprint Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663241)*.*.
  - **Extensible Attributes**: Add and delete extensible attributes that are associated with the DHCP fingerprint filter. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
...
- For a NAC filter, the NAC Filter editor contains the following tabs from which you can modifying information:
  ...
  - **Rules:** Modify the rules as described in [*Defining*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[*NAC*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[*Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)
  - **DHCP Options**: Add or delete DHCP options. For information, see [*Defining*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[*NAC*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589)[*Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270605/About+NAC+Filters#AboutNACFilters-bookmark2589).
  - **Extensible Attributes**: Add and delete extensible attributes that are associated with a specific DHCP range. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215)*.*
...
2. The *MAC* *Address* *Filter* *Item* editor contains the following tabs from which you can edit data:
   ...
   - **General**: Modify the fields as described in [*Adding MAC Address Filter Items*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403799).
   - **Registration**: Modify registration settings as described in [*Adding MAC Address Filter Items*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403799).
   - **Extensible** **Attributes**: Add or delete extensible attributes that are associated with a specific DHCP range. You can also modify the values of extensible attributes. For information, see [*Using Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
3. Save the configuration and click **Restart** if it appears at the top of the screen.
