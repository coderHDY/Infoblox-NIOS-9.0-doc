...
1. Add an option space called MSFT, and then add the following options to it. For information, see [*Applying DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271370).
...
1. Add a DHCP range to the network. For information, see [*Configuring IPv4 Address Ranges*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663590).

1. Apply the i86pc option filter to the DHCP address range. For information, see [*Applying Filters to DHCP Objects*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743).
