...
- It is not part of a scheduled task that involves a fixed address. For information about how to schedule a task, see *[Scheduling Tasks](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280790666)*.
