...
- Add a reservation.
- Convert a fixed address or a dynamic address with an active lease to a reservation. For information, see* *[*Converting Objects Associated with IP Addresses*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1420166055).
- Define a fixed address with an IP address. For information, see [*Adding IPv4 Fixed Addresses*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1320357604)*.*
...
> panel, enter a date, time, and time zone. For information, see [*Scheduling Tasks*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280790666).
...
4. Click **Next** to configure or override DHCP options as described in [*Defining IPv4 DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280271370).
...
2. The *Reservation* *Address* editor contains the following tabs from which you can modify data:
   ...
   - **IPv4** **DHCP** **Options:** Keep the inherited DHCP options or override them and enter unique settings for the reservation. For information, see [*Defining IPv4 DHCP Options*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1331332118).
   - **IPv4** **Discovered** **Data**: Displays the discovered data of the reservation. For information, see [*Viewing Discovered Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666433).
   - **Port** **Reservation**: Review and edit any device port reservations that may be defined for the current object, or create a new port reservation and schedule it. For a closer look, see the section [*Port Control Features in Network Insight*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280406109)[,](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666028) and steps 4-8 in the section Adding IPv4 Reservations above.
   ...
   - **Permissions**: This tab appears only if you belong to a superuser admin group. For information, see [ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1343324639)[*Managing Permissions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1343324639).
3. Optionally, you can click **Toggle Advanced Mode** to display the following tabs from which you can modify advanced data.
   ...
   - **IPv4 BOOTP/PXE**: You can keep the inherited BOOTP properties or override them and enter unique settings for the reservation. For information, see [*Configuring IPv4 BOOTP and PXE Properties*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280663785).
   - **Filters**: You can keep the inherited IPv4 logic filters or override them and add a new IPv4 logic filter. For information, see [*Applying*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[*Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[*to*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[*DHCP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[*Objects*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270743)  
