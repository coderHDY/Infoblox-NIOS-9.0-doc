...
1. Create the following DHCP range templates. For information, see Adding IPv4 Range Templates above.
   ...
   - Exclusion range with the following values. You must modify the *Workstations* template to add the exclusion range. For information, see [*Modifying IPv4 Range Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1394574228)*.*
     
     - **Name:** Exclusion
     - **Offset:** 42
     - **Number of Addresses:** 10
     - **Comment:** Excluding addresses 74 to 83 from the DHCP range 32 to 131.
2. Create a fixed address/reservation template with the following values. For information, see [*Adding IPv4 Fixed Address/Reservation Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1394574276)[About IPv4 DHCP Templates#Adding-IPv4-Fixed-Address%2FReservation-Templates](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280404118/About+IPv4+DHCP+Templates#Adding-IPv4-Fixed-Address%2FReservation-Templates)above.
   
   - **Name:** Router
   - **Comment:** Fixed address template
   - **Offset:** 1
   - **Number of Addresses:** 1
3. Create a fixed address/reservation template with the following values. For information, see[* Adding IPv4 Fixed Address/Reservation Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1394574276)* *above.
   
   - **Name:** myFixedAddress
   - **Comment:** Fixed address template
   - **Offset:** 22
   - **Number of Addresses:** 10
4. Create a network template with the following values. For information, see [*Adding IPv4 Network Templates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1394574414).
...
8. Create a network using the network template *myNetworkTemplate* with the following values. For information, see [*Adding IPv4 Networks*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1432813878).
