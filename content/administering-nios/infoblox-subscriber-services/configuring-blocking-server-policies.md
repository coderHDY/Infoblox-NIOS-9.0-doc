...
The policy that you created is displayed in the table. You can then associate IP addresses with the policy that you created. For more information, see *[Scaling Using Subscriber Sites and IPSD](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280660641)*.
