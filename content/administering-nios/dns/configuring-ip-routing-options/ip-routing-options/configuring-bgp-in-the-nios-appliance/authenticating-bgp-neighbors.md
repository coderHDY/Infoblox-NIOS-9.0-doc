...
5. Anycast configuration is complete. To activate anycast, see* *[*Specifying Port Settings for DNS*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/281215121)* *and its subtopic, [*Specifying Source Ports*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/281215121/Specifying+Port+Settings+for+DNS#Specifying-Source-Ports).
