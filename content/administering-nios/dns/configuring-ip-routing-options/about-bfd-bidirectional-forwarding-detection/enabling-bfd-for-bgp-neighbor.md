...
You can use the `show bgp neighbor` CLI command to view runtime BFD information for BGP. For more information, see [*show bgp*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280266213).
