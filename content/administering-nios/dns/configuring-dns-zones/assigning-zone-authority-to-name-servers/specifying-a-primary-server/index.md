...
In Grid Manager, you can specify the primary server for a zone when you create it using the *Add* *Authoritative* *Zone* wizard or when you edit an existing zone using the *Authoritative* *Zone* editor. For information on how to add a new zone through the wizard, see [*Configuring Authoritative Zones*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280763330). The following procedure describes how to access the editor of a zone. To specify a primary server for an existing zone:
