...
4. In the *Add Delegation* wizard, specify the following:
   ...
   - For information about RFC 2317, see [*Specifying an RFC 2317 Prefix*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272705)*.*
...
5. Click **Next** to assign a delegation name server group or define the name servers for the zone. Select one of the following:
   ...
   For information about delegation NS groups, see [*Using Delegation Name Server Groups*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272489)*.*
