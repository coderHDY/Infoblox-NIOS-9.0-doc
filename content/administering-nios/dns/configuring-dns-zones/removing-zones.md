...
> ### Note
> 
> Instead of removing a zone, you can also disable it. For more information, see [*Enabling and Disabling Zones*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280763205)[.](https://infoblox-docs.atlassian.net/wiki/pages/createpage.action?spaceKey=nios90&title=Enabling%20and%20Disabling%20Zones&linkCreation=true&fromPageId=280405463)
...
You can also schedule the deletion for a later time. Click **Schedule** **Deletion** and in the *Schedule* *Change* panel, enter a date, time, and time zone. For information, see [*Scheduling Deletions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/504168883). For information about scheduling recursive deletions of zones, see [*Scheduling New IPAM/DHCP Objects and Associated Port Configurations*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/504168883)*.*
