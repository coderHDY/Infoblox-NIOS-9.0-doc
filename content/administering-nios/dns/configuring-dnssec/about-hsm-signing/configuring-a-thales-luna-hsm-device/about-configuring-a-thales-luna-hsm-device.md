...
1. On the Grid, generate a client certificate for the Grid Master and Grid Master Candidate. For information, see* *[*About Client Certificates*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1320421549). If you are upgrading the Thales Luna HSM from Luna 5 or 6 to Luna 7 CPL, you must generate a new client certificate.
