...
When you use an HSM, the appliance does not delete the key from HSM. For more information, see [*About HSM Signing*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280664372).
