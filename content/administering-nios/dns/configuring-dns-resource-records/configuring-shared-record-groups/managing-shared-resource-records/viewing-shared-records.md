---
title: "Viewing Shared Records"
source: "/space/nios90/1340736898"
pageId: "1340736898"
---
...
- From the **Data** **Management** tab, select the **DNS** tab -> **Shared** **Record** **Groups** tab -> *shared_record* _*group* -> **Shared** **Records** tab.
...
- Create a quick filter to save frequently used filter criteria. For information, see [*Using Quick Filters*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280401588)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280401588)
