...
1. Create a new forward-mapping zone called example.exam200.com. See [*Creating an Authoritative Forward-Mapping Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405638).
...
5. On the ns1.exam200.com name server, add example.corp200.com as a delegated zone and specify ns1.example.com as the name server for it. See[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762909)[*Configuring a Delegation*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762909).
