...
NIOS allows superusers to add AAAA records with a blank name. Limited-access users must have read/write permission to **Adding** **a** **blank** **A/AAAA** **record** to add AAAA records with a blank name. You can assign global permission for specific admin groups and roles to allow limited-access users to add blank AAAA records. For more information, see [*Administrative Permissions for Adding Blank A or AAAA Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280765861).
