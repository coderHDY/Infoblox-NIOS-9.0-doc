...
A visualization chart is displayed that represents the pool hierarchy. You can hover over the server icons to view the health status of the monitors associated with the server. For more information about health monitors, see *[Using DNS Traffic Control Health Monitors](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280404830)*.
