...
- Hosts—You can configure IPv4 and IPv6 addresses for hosts. For information, see [*Adding Host Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280666779).
...
| --- | --- |
| 1. Create primary or secondary name servers and specify an IPv6 root server. | - [*Configuring Authoritative Zones*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280763330) - [*Specifying a Primary Server*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272599) - [*Specifying Secondary Servers*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272599) - [*Creating a Root Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405638/Creating+an+Authoritative+Forward-Mapping+Zone#Creating-a-Root-Zone) |
| 1. Configure the IPv6 zones. | - [*Creating an Authoritative Forward-Mapping Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405638) - [*Creating an Authoritative Reverse-Mapping Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272705) |
| 1. Configure IPv6 resource records | - [*Managing AAAA Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762656) - [*Managing PTR Records*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280762656) |
