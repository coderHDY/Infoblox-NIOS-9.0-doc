...
1. Import the keytab file from your management system to the appliance and enable GSS-TSIG dynamic updates at the Grid or member level. For information, see [*Enabling GSS-TSIG Authentication for DHCP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405160).
2. Configure the appliance to send GSS-TSIG dynamic updates to forward-mapping and optionally, reverse-mapping zones on the DNS server. For information, see [*Managing GSS-TSIG keys*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405160).
