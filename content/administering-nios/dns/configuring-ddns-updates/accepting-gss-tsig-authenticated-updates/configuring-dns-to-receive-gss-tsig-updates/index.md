...
2. Configure a forward-mapping zone with the same name as the AD zone. For information, see [*Creating an Authoritative Forward-Mapping Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405638).
3. (Optional) Create a reverse-mapping zone for the network address space that corresponds to the domain name space in the forward-mapping zone. For information, see [*Creating an Authoritative Reverse-Mapping Zone*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272705)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280272705)
4. Import the zone data from the AD domain controller. For information, see [*Importing Zone Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280665197).
