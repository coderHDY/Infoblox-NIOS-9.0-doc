...
3. Enable DNSSEC validation as described in [*Enabling DNSSEC Validation*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280664316).
4. Ensure that the configuration is verified before removing trust anchors. Trust anchors are essential for DNSSEC validation, as they verify the authenticity of DNS responses. To configure trust anchors, see [* Enabling DNSSEC Validation*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280664316).
