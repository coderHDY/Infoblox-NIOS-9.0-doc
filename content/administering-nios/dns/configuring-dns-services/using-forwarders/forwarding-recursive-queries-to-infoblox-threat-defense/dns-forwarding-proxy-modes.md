...
For steps to configure the DNS Forwarding Proxy mode, see [*Enabling Detect Only Mode on DNS Forwarding Proxy*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1857782004).
