...
4. Select the **Enable** **last** **queried** **time** **monitoring** **for** **resource** **records** checkbox. For more information, see [*Configuring DNS Record Scavenging Properties*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280405717).
5. Click **Save** **&** **Close**.
