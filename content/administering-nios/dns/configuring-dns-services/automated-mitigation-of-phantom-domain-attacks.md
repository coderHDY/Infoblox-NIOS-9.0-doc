...
All events related to these operations are logged to the syslog. For information about the syslog and how to use it, see [*Using a Syslog Server*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403148).
...
> ### Note
> 
> - Updating the parameter values for mitigating phantom domain attacks takes effect immediately through Grid replication. However, for these values to be updated in the named.conf file, you need to restart the DNS service. To restart the member service, see [*Restarting Services*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280273950).
