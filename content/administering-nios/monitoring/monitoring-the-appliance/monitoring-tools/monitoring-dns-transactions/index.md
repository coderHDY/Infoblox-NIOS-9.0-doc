...
- Enable SNMP traps and e-mail notifications. For information, see [*Configuring SNMP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280662492).
- Review the DNS alert status. For information, see Viewing DNS Alert Indicator Status below.
- Identify the source of the attack by reviewing the DNS alert status, syslog file, and SNMP traps. For information on SNMP traps for DNS alerts and threshold crossing traps, see [*SNMP MIB Hierarchy*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760493).
