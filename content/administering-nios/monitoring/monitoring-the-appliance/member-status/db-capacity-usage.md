...
pageId: "1320357184"
---
Grid Manager displays the current percentage of the database in use on the selected Grid member. It also describes whether the usage has exceeded the trigger or reset value. Note that the trigger and reset values are user configurable. The default trigger value is 80% and the reset value is 70%. For information about using the capacity report, see [*Monitoring Tools*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403049). The status icon can be one of the following:
