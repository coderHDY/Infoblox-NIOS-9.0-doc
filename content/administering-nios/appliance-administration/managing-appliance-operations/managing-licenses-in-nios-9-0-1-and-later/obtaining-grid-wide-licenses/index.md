...
For more information, see [*About IB-Flex*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667152). After you install the **Flex** **Grid** **Activation** license, you can view it on the **Infoblox Grid** tab -> **Licenses** tab -> **Grid** **Wide** tab in Grid Manager.

You can install the **Flex** **Grid** **Activation** license on a Grid Master even if IB-FLEX is not a part of the Grid, but this license is effective only for an IB-Flex member. The Infoblox License Portal allows you to acquire any number of **Flex** **Grid** **Activation** license keys for each individual Grid. To install a temporary license, use the  [*set temp_license*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/220168268) CLI command.
...
You can install the Flex Grid Activation for Managed Services license only on a Grid Master or a standalone appliance. To install a temporary license, use the [*set temp_license*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/220168268) CLI command.
