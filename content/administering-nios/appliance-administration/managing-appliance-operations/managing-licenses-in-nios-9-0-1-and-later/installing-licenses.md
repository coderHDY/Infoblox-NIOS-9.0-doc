...
- [*set license*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280790001): Contact the Infoblox Support to obtain the license string and then use this command to add the license.
- [*set temp_license*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/220168268): Use this command to generate and install temporary licenses.
