...
> ### Note
> 
> * Zone transfers for Microsoft servers do not support named ACLs. However, you can still use individual ACEs to configure access control. For more information about how to configure zone transfer settings for Microsoft servers, see [*Setting Zone Properties*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270513)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280270513/Managing+Synchronized+DNS+Data#Setting Zone Properties) In addition, the DNSone 2.x TSIG key supports only the "Allow" permission. You cannot change "Allow" to "Deny."

Complete the following tasks to use a named ACL:

1. Define a named ACL, as described in [*Defining Named ACLs*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667593)*.*
2. Validate the named ACL, as described in [*Validating Named ACLs*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274318)*.*
3. Apply the named ACL to specific operations, as described in* *[*Applying Access Control to Operations*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667621).
