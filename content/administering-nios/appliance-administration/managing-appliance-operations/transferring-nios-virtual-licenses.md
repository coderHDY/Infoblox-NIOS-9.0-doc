...
1. Obtain replacement license keys from Infoblox.  
   Based on the version of NIOS, see [*Managing Licenses in NIOS 9.0.0*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667194) or [*Managing Licenses in NIOS 9.0.1 and Later*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/318670359) for more information.
...
According to the version of vNIOS and the appliance model, see [*Managing Licenses in NIOS 9.0.0*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667194) and/or [*Managing Licenses in NIOS 9.0.1 and Later*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/318670359)* *for more information about managing and viewing licenses. You can also use the CLI command *show license revoked* to view information about the replaced licenses.
