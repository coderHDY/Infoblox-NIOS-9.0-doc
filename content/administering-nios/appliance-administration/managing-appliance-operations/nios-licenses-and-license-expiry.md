...
> **Note**
> 
> NTLMv2 is the only authentication method supported for Microsoft servers managed from Infoblox Grids. For information about managing Microsoft Windows servers from Grid Manager, see [*Managing Microsoft Windows Servers*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280267775).
