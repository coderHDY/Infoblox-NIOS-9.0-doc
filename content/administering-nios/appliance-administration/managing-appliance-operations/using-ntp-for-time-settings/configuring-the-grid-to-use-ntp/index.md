...
- Enable the NTP service on the Grid and specify one or more external NTP servers. For information, see [Synchronizing the Grid with External NTP Servers](administering-nios/appliance-administration/managing-appliance-operations/using-ntp-for-time-settings/configuring-the-grid-to-use-ntp/synchronizing-the-grid-with-external-ntp-servers).
