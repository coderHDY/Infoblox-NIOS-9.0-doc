...
For more information about how to configure inheritable extensible attributes, see [*Configuration Examples for Inheritable Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280765105)*.*
