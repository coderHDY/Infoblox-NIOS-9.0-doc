...
Activities such as additions, modifications, and deletions of inheritable extensible attributes, are recorded in the audit log. For more information about how to use the audit log, see [*Using the Audit Log*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280403049).  
...
Users can enable the appliance to group members by extensible attributes. For more information, see [*Grouping Members by Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/686097129).  
  
When you first enable Cloud Network Automation, NIOS installs a set of extensible attributes that are specific for cloud usage. You should avoid adding these extensible attributes manually before enabling Cloud Network Automation. For more information, see [*Extensible Attributes for Cloud Objects*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280407399)*.*
