...
pageId: "280408237"
---
Permissions  for Common Tasks table lists some of the common tasks admins can perform and their required permissions. [*Permission for Network Discovery*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90draft/pages/73273654/Administrative+Permissions+for+IPAM+Resources#Administrative-Permissions-for-Network-Insight-Tasks) table[ ](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280668320/Administrative+Permission+for+the+Grid#bookmark513)lists tasks related to device discovery, with their required permissions.  
