...
Note that the following fields in the wizard do not apply to this feature: **Enable** **NAC** **Filter**, **Cache** **Time** **to** **Live**, and **Recovery** **Interval**. They are used with the NAC Integration feature described in [*Authenticated DHCP*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280660965).
