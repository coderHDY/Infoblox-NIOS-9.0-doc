...
3. Optionally, click **Next** to add extensible attributes to this role. For information, see [*About Extensible attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
4. Click **Next** and select one of the following:
   
   - **Save** **&** **Add** **Permissions**: Save the entry and add permissions to the role. Grid Manager displays the **Permissions** tab with the newly created role selected. You can then add permissions to this role. For information, see [*About Administrative Permissions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280275424).
...
2. The *Copy* *Role* editor provides the following tabs from which you can modify data for the new role:
   ...
   - **Extensible Attributes**: Add and delete extensible attributes that are associated with the admin role. You can also modify the values of the extensible attributes. For information, see [*About Extensible Attributes*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274215).
...
- Define their permissions. For information and guidelines on defining permissions, see [*About Administrative Permissions*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280275424).
- Assign roles to admin groups, as described in creating limited-access admin groups, see [*About Admin Groups*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280275587).
