...
- In the authentication policy, add the newly configured TACACS+ server group and the TACACS+ admin group name. See [*Defining the Authentication Policy*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280275233) for more information about configuring an admin policy.
