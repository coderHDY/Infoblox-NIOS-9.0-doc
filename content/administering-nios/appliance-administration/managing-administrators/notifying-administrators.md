...
- Events that generate traps, except for upgrade failures (ibUpgradeFailure). For a list of events and Infoblox MIBs, see *[SNMP MIB Hierarchy](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280760493)**.*
