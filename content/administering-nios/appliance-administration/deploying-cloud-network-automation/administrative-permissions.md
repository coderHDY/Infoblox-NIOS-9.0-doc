...
3. On **CPI**, add **APIUser1** and on **CP2**, add **APIUser2** to the list of administrators that can send cloud API requests, as described in [*Configuring Grid and Member Cloud API Properties*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280407427)[.](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280407427)
