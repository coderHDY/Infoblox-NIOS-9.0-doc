---
title: "Deploying Cloud Network Automation"
source: "/space/nios90/280758966"
pageId: "280758966"
---
...
To maximize the capability of Cloud Network Automation, ensure that you understand the operations of Cloud Network Automation and how to deploy necessary components to suit your network topology and CMP. For detailed information about the Cloud Network Automation operations, see [*Cloud Network Automation*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280407487).

With valid licenses installed, depending on the version of NIOS, you can either configure the Trinzic X5 cloud platform appliances in your Grid or use the cloud platform functionality in the Trinzic X6 appliances to provide DNS and DHCP services for virtual machines and network devices deployed through a CMP (Cloud Management Platform). For more information, see [*Managing Licenses in NIOS 9.0.0*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280667194) and [*Managing Licenses in NIOS 9.0.1*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/318670359).

To deploy a Grid that contains cloud members, it is important to understand the required components, how to configure the members to enable Cloud Network Automation, and which cloud API objects are supported.

*[children]*

# Related topic

[Cloud Network Automation](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280407487)
