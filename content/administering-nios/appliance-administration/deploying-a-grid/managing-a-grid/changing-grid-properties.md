...
4. **Shared** **Secret** **Retype:** Type the shared secret again to confirm its accuracy.
   ...
   - **VPN** **Port:** Type the port number that the Grid members use when communicating with the Grid Master through encrypted VPN tunnels. The default port number is 1194. For more information about port numbers for grid communication, see [*Creating a Grid Master*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/319488802)*.*
