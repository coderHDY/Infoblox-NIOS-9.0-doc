...
- The IP address of the MGMT port (if enabled) of the active node of an HA or single Grid Master. See [*Using the MGMT Port*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/660144129).
