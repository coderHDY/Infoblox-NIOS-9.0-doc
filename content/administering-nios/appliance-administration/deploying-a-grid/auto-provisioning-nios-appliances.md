...
3. Add the appliance as a Grid member. For information about adding Grid members to the Grid, see [*Adding Grid Members*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/686097129).
