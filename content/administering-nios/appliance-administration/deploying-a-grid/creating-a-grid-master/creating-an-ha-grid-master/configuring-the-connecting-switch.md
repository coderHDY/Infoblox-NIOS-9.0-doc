...
- **DHCP Snooping**: Disable or Enable Trust Interface.
  ...
  Note that you must disable DHCP Snooping to successfully run DHCP services on the Grid. For more information about DHCP services, see [*About Infoblox DHCP Services*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280401287).
...
> ### Note
> 
> By default, a NIOS appliance automatically negotiates the optimal connection speed and transmission type (full or half duplex) on the physical links between its LAN1 or LAN1 (VLAN), HA, and MGMT ports and the Ethernet ports on the connecting switch. If the two appliances fail to auto-negotiate the optimal settings, see [*Modifying Ethernet Port Settings*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280274166)* *for steps you can take to resolve the problem.
