...
2. Log in using the default username and password: **admin** and **infoblox**. For detailed information about logging in to the GUI, see [*Logging on to the NIOS UI*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280759087).
...
6. On the next screen, specify the network properties and click **Next**:  
   Note: If you are deploying HA over a public cloud platform such as AWS, Azure, or Google Cloud, see the [*HA Master - Node 1 Deployed on Public Cloud*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/1480950527) section for additional steps.
