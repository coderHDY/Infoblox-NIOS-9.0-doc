...
- For smaller DNS data sets, you can use the zone import feature, which allows you to import data on a per-zone basis (see [*Importing Zone Data*](https://infoblox-docs.atlassian.net/wiki/spaces/nios90/pages/280665197)).
