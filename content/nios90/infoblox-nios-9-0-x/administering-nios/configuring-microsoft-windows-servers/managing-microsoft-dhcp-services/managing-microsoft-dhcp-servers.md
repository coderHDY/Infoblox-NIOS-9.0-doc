...
For information on removing and disabling Microsoft servers, see *[Managing Microsoft Servers](/nios90/infoblox-nios-9-0-x/administering-nios/configuring-microsoft-windows-servers/managing-microsoft-windows-servers/managing-microsoft-servers)**.*
