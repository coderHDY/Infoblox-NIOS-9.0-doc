...
To add Active Directory Sites, you must have Read/Write permission on the respective Active Directory Domain with which it is associated. For more information about permissions, see *[Configuring and Managing Server Permissions](/nios90/infoblox-nios-9-0-x/administering-nios/configuring-microsoft-windows-servers/managing-microsoft-windows-servers/configuring-active-directory-sites-and-services)*.  
