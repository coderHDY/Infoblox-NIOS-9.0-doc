...
- For a VM affiliation conflict, you can either update all the displayed objects to be affiliate with the discovered data or keep the current affiliation and clear the conflict. For more information, see  Resolving VM Affiliation Conflicts below[.](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/ip-discovery-and-vdiscovery/managing-discovered-data/Managing+Discovered+Data#bookmark1373)
