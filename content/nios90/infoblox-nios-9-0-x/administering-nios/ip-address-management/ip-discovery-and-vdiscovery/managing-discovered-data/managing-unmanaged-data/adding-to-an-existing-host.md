---
title: "Adding to an Existing Host"
source: "/space/nios90/1432719371"
pageId: "1432719371"
---
...
2. In the *Select* *Host* dialog box, select a host from the table. You can also search for a host using filters or the Go to function. For information Using filters and Using the go to Function , see [*Finding and Restoring Data*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/performing-basic-operations-using-grid-manager/finding-and-restoring-data). Click the Select icon to select the desired host.  
