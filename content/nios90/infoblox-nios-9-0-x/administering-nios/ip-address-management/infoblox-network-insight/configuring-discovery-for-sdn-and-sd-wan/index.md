...
To view discovery results for SDN and SD-WAN, go to **Data Management **&gt; **Devices**. For information, see [*Viewing Discovered Devices and their Properties*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/infoblox-network-insight/viewing-discovered-devices-and-their-properties).
