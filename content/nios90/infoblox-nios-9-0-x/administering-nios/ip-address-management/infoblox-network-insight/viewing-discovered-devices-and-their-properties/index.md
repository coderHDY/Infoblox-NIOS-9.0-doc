...
> ### Note
> 
> For information about managed and unmanaged devices, see [*Converting Unmanaged Devices to Managed Devices*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/infoblox-network-insight/managing-discovered-data-280764086/Managing+Discovered+Data#CUDM). You can also use the "Unmanaged devices and networks" filter in global search to locate all the unmanaged devices and networks discovered through discovery. For more information, see [*Using Global Search*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/about-the-grid-manager-interface).
