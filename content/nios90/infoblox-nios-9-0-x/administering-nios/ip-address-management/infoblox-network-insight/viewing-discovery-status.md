...
For more information about checking and diagnosing discovery behavior for devices listed in the status table, see the following topic [*Executing Discovery Diagnostics*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/infoblox-network-insight/executing-discovery-diagnostics).
