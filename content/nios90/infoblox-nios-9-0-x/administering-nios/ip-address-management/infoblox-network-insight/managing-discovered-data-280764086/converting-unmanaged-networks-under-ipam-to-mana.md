...
> ### Note
> 
> Most conversion operations for networks and individual IP addresses are managed under IPAM and are described in the section [*Managing IPv4 and IPv6 Addresses*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/managing-ip-addresses/managing-ipv4-and-ipv6-addresses)*.*
