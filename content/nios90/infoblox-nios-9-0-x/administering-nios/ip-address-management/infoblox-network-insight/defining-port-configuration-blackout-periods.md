...
4. Click the **Enable** **Port** **Configuration** **Blackout** checkbox.
   ...
   1. Select the **Use** **Discovery** **Blackout** **Schedule** checkbox to apply the same blackout schedule to port configurations that is applied locally to discovery blackouts. (For more information on discovery blackouts, see [*Defining Blackout Periods*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/infoblox-network-insight/defining-blackout-periods).)  
      –or–
