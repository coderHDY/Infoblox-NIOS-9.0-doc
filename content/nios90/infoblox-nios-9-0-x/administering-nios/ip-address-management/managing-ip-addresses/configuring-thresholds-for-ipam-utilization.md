...
You can configure the thresholds for IPAM utilization at the Grid level and override them at the network level. To configure the IPAM utilization thresholds at the Grid level, see [*Defining Threshold for Traps*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-with-snmp/configuring-snmp).  
