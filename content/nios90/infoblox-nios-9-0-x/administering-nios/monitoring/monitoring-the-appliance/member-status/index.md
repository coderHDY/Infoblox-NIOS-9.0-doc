...
- **DHCP**, **DNS**, **TFTP**, **HTTP**, **FTP**, **NTP**, **bloxTools**, **Captive** **Portal**, **DNS** **Accelerator** **usage**, **Reporting,** **Discovery,** **DNS Infrastructure** **Protection,** **Cloud-API,** **Threat** **Insight,** **TAXII**: The status icons indicate whether these services are running properly. For information about service status, see [*Monitoring Services*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/monitoring-services).
