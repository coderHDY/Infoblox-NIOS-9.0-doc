...
For instructions to enable DNS queries or responses, see the *Enabling Query Logging* section below. To manage the visibility of the warning message, see [*set query_logging_warnings*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/set-commands/set-query-logging-warnings).
...
For more information about the `set query_logging_warnings` CLI command, see [*set query_logging_warnings*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/set-commands/set-query-logging-warnings).
