...
pageId: "1406500868"
---
To enable SNMPv3, you must first configure SNMPv3 users on the appliance. For information about SNMPv3, see [*Understanding Simple Network Management Protocol*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-with-snmp/understanding-simple-network-management-protocol)*.*
...
3. Click **Next** to define extensible attributes. For information, see [*Using Extensible Attributes*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-extensible-attributes).
