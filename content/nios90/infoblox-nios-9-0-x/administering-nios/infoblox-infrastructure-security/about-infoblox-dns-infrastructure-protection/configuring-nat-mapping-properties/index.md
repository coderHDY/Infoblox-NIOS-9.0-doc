...
For information about the syslog and how to use it, see *[Viewing the Syslog](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/using-a-syslog-server)*. Note the following about the NAT mapping feature:
