...
- The memory required to support the DNS over HTTPS feature is available. For more information, see [Base Configuration Requirements](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-services/configuring-dns-over-tls-and-dns-over-https-serv/base-configuration-requirements).
