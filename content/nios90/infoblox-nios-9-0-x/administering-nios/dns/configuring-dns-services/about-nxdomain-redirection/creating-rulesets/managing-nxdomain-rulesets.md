---
title: "Managing NXDOMAIN Rulesets"
source: "/space/nios90/1420198258"
pageId: "1420198258"
---
...
- Edit a ruleset, by clicking its checkbox and clicking the Edit icon. You can set the following in the NXDOMAIN Ruleset editor:
  ...
  - In the **Rules** tab, you can do the following:
    ...
    - In the **Permissions** tab, you can set admin permissions for the ruleset. For information about admin permissions, see [*Managing Administrators*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators)*.*
