...
- View the DNS Traffic Control structure for an LBDN.
  ...
  - Select the LBDN record and click the Open Visualization icon. For more information, see [*Visualization for DNS Traffic Control Objects*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/visualization-for-dns-traffic-control-objects)*.*
