...
2. In the *Add * *TLSA* * Record* wizard, complete the following fields:
   ...
   - **Select ** **Zone**: Click to select a zone. In NIOS 8.5, you must select only a signed zone to associate with a TLSA resource record. In NIOS 8.5.1 or later, you can select a signed zone or an unsigned zone. For more information, see [*Signing a Zone*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dnssec/signing-a-zone). Click **Clear** to clear the **Name** that you have entered.
...
- Use **Global** **Search** to search for TLSA records. For information, see [*Global Search*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/about-the-grid-manager-interface).
- Use **Copy** **Records** to copy TLSA records between DNS zones. For information, see [*Copying Zone Records*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/dns-views/configuring-dns-views)*.*
- Define global permission for **All** **TLSA** **records** with read-only, read/write or deny access. You can also define object level permission for TLSA records. For information, see [*Defining Global Permissions*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/about-administrative-permissions) and [*Defining Object Permissions*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/about-administrative-permissions)*.*
...
- View audit log entries for the TLSA record. For information, see [*Viewing the Audit Log*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/monitoring-tools).
