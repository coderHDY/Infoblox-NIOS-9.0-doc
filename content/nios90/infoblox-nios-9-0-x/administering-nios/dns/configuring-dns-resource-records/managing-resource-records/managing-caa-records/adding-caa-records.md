...
3. Save the configuration or click **Next** to define extensible attributes. For information, see [*Managing Extensible Attributes*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-extensible-attributes).
4. Save the configuration or click **Next** to schedule this task. Click **Now** in the **Schedule Change** panel to immediately execute this task or click **Later** and specify a date, time, and time zone. For information about how to schedule a task, see [*Scheduling Tasks*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/scheduling-tasks).
...
- Use **Global** **Search** to search for CAA records. For information, see [*Global Search*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/about-the-grid-manager-interface)*.*
- Use **Copy** **Records** to copy CAA records between DNS zones. For information, see [*Copying Zone Records*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/dns-views/configuring-dns-views)[.](/nios90/infoblox-nios-9-0-x/administering-nios/dns/dns-views/configuration-example-configuring-a-dns-view/Configuration+Example+Configuring+a+DNS+View#bookmark1700)
- Define global permission for **All** **CAA records** with read-only, read/write or deny access. You can also define object level permission for CAA records. For information, see [*Defining Global Permissions *](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/about-administrative-permissions)and [*Defining Object Permissions*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/about-administrative-permissions).
...
- View audit log entries for the CAA record. For information, see [*Viewing the Audit Log*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/monitoring-tools).
