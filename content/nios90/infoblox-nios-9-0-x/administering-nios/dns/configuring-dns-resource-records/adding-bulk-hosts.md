...
3. Click **Next** to define extensible attributes for the bulk host record. For information, see [*Using Extensible Attributes*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-extensible-attributes).
4. Save the configuration and click **Restart** if it appears at the top of the screen

To modify or delete a bulk host, see [*Modifying, Disabling, and Deleting Host and Resource Records*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-resource-records/managing-resource-records).
