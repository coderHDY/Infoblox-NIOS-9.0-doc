...
4. Click **Next** and complete the following:
   ...
   - (SNMPv3 only) **SNMPv3User**: Click **Select** or **Create** to specify an SNMPv3 user. For information about SNMPv3 users, see [*Configuring SNMP*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-with-snmp/configuring-snmp).  
...
- **OID**: Specify the object identifier. An OID is a unique dotted-decimal number that identifies the location of the object in the MIB tree. For more information about OIDs, see [*SNMP MIB Hierarchy*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-with-snmp/snmp-mib-hierarchy)*.*
