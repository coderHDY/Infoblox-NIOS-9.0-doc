...
- **Status**: Displays information about the last update, connection status, load balancer methods, and servers and pools. Hover your mouse over the status value to view full information in a tooltip. For more information about the possible statuses, see as described in [*Understanding DTC Object Status*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/visualization-for-dns-traffic-control-objects/Visualization+for+DNS+Traffic+Control+Objects#Understanding-DTC-Object-Status)*.*
...
- Select the checkbox to view specific objects only:
  ...
  - **LBDN**: Select the checkbox to view LBDN objects only. For more information, see [*Configuring DNS Traffic Control LBDNs*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/managing-dns-traffic-control-objects/managing-dns-traffic-control-lbdns).
  - **Pool**: Select the checkbox to view pools only. For more information, see [*Configuring DNS Traffic Control Pools*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/managing-dns-traffic-control-objects/managing-dns-traffic-control-pools).
  - **Server**: Select the checkbox to view servers only. For more information, see [*Configuring DNS Traffic Control Servers*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/managing-dns-traffic-control-objects/managing-dns-traffic-control-servers).
- Change the set of columns displayed in the DTC objects table and change their width. For more information, see [*Customizing Tables*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/about-the-grid-manager-interface/About+the+Grid+Manager+Interface#Customizing-Tables).* *
...
- Click a DTC server name to open the list of DTC records associated with the server. For more information, see* *[*Managing DTC Server Records*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/managing-dns-traffic-control-objects/managing-dns-traffic-control-servers/Managing+DNS+Traffic+Control+Servers#Managing-DTC-Server-Records).
...
- Use the **IDN** **Converter** from the Toolbar to convert IDNs into punycodes. For more information, see [*Decoding IDNs and Encoding Punycode*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/performing-basic-operations-using-grid-manager/managing-internationalized-domain-names).
...
To schedule an object deletion, click the Action icon of the object and select **Delete** -&gt; **Schedule** **Delete**. Alternatively, you can select the object in the **Traffic** **Control** panel and then select the Delete icon -&gt; **Schedule** **Delete**. In the *Schedule* *Deletion* panel, enter a date, time, and time zone. For information, see [*Scheduling Deletions*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/scheduling-new-ipam-dhcp-objects-and-associated-/scheduling-deletions).

> **warning**
>
> Note
> 
> If you remove a name server associated with a zone that comprises LBDN records and if the name server is configured as part of a [*consolidated monitor list*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/configuring-dtc-monitors-for-health-check), ensure that you remove the name server from the consolidated health monitor list in the DTC pool. For more information about health monitors, see [*Using DNS Traffic Control Health Monitors*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/using-dns-traffic-control-health-monitors) and [*Configuring DTC Monitors for Health Check*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/managing-dns-traffic-control/configuring-dtc-monitors-for-health-check).
