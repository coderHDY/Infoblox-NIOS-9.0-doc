...
As noted in the section [*Configuring Anycast Addresses*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-ip-routing-options/configuring-anycast-addresses), you configure OSPF or BGP4 to advertise anycast addresses, which configured on the loopback interface of NIOS appliances. Use of either protocol depends on the network topology, based on whether the advertisements will propagate only within a single AS or between more than one AS. The following figure shows a simplified example.
