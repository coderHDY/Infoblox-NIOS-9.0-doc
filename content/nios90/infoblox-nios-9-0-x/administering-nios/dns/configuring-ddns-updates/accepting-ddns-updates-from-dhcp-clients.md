...
- Create a forward-mapping zone, as described in [*Creating an Authoritative Forward-Mapping Zone*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/creating-an-authoritative-forward-mapping-zone). Give it a name that matches the AD DNS zone whose resource records you want to import.
- Specify the domain controllers from which the appliance can receive updates, as described in Configuring AD Support below*.*
- Import the zone date from the domain controller. For information, see [*Importing Data into Zones*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/importing-zone-data).
...
You can then import zone data, as described in [*Importing Data into Zones*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/importing-zone-data).
