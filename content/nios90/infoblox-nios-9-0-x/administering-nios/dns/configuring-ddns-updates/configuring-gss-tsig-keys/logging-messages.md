...
For more information about audit logs, see [*Using the Audit Log*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/monitoring-tools). You can search Kerberos keys using the realm (domain), principal name or an encryption type.
