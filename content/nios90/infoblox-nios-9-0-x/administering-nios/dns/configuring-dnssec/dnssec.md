...
> ### Warning
> 
> *When* *you* *disable* *EDNS0* *on* *the* *appliance,* *all* *outgoing* *DNSSEC* *queries* *to* *zones* *within* *trusted* *anchors* *will* *fail* *even* *if* *DNSSEC* *validation* *is* *enabled.* *To ensure* *that DNSSEC* *functions* *properly,* *do* *not* *disable* *EDNS0* *on* *the* *appliance.* *For* *more* *information,* *see* [*Using Extension Mechanisms for DNS (EDNS0)*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-services/configuring-dns-service-properties/using-extension-mechanisms-for-dns-edns0)*.*
