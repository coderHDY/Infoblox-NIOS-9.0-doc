...
In addition, signed zones can accept dynamic DNS updates. For information about configuring zones to accept dynamic DNS updates, see [*Configuring DNS Servers for DDNS*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-ddns-updates/configuring-dns-servers-for-ddns).
