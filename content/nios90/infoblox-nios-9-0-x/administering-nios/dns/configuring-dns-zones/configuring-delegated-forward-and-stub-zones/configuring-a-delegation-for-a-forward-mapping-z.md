...
4. In the *Add Delegation* wizard, specify the following:
   ...
   - **Lock**: Click this checkbox to lock the zone so that you can make changes to it, and also prevent others from making conflicting changes. For information, see [*Locking and Unlocking Zones*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/locking-unlocking-enabling-disabling-zones).
...
5. Click **Next** to assign a delegation name server group or define the name servers for the zone. Select one of the following:
   ...
   For information about delegation NS group, see [*Using Delegation Name Server Groups*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/using-name-server-groups).
