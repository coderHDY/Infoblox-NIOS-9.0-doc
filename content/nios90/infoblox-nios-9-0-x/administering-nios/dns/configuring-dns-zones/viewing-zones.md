...
- **KSK rollover date**: Displays the date when the KSK is due for next rollover. The appliance performs a rollover automatically at this time if you have enabled automatic KSK rollover. For more information, see [*Configuring Automatic KSK Rollovers and Notifications*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dnssec/signing-a-zone/managing-signed-zones/configuring-automatic-ksk-rollovers-and-notifica). You must perform the rollover manually, if you have disabled this option.
