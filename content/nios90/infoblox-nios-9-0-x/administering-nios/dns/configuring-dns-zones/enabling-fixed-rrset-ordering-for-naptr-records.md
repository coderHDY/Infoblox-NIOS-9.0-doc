...
- When you import NAPTR records to an empty zone, you must use the **Add** CSV import option and to update the zone data you must use the **Replace** CSV import option to ensure that the RRset order of the NAPTR records is the same as specified in the CSV import file. For more information about CSV import feature, see [*Guidelines for CSV Import*](/nios90/infoblox-nios-9-0-x/reference-information/csv-import-reference/guidelines-for-csv-import)*.*
...
3. Click the **Advanced** subtab of the **General** tab and then complete the following:
   ...
   - **Enable fixed RRset ordering**: Select this checkbox to enable fixed RRset ordering for the NAPTR records that are added to the authoritative zone through CSV import, as described in [*Guidelines for CSV Import*](/nios90/infoblox-nios-9-0-x/reference-information/csv-import-reference/guidelines-for-csv-import).
