...
2. The *Subscriber Site Properties* editor provides the following tabs from which you can modify data:
   ...
   4. You can enter or edit information in the **Extensible Attributes** tab, as described in [*Managing Extensible Attributes*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-extensible-attributes).
