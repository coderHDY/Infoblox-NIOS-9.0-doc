...
You can create fixed addresses as described in Adding IPv4 Fixed Addresses below or from the Tasks Dashboard. For information about the Tasks Dashboard, see [*The Tasks Dashboard*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/dashboards/tasks-dashboard). You can also create a fixed address when you create a host record or when you convert an active, dynamically leased address to a fixed address. For more information, see [*Adding Host Records*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/managing-ip-addresses/about-host-records) and [*Converting DHCP Leases*](/nios90/by-id/1420198741).  
