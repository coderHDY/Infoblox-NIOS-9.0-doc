...
2. The *IPv6* *Fixed* *Address* *Template* editor contains the following tabs from which you can modify data:
   ...
   - **General**: Modify general information for the template as described in [*Adding IPv6 Fixed Address Templates*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/managing-dhcp-templates/about-ipv6-fixed-address-templates/About+IPv6+Fixed+Address+Templates#Adding-IPv6-Fixed-Address-Templates) above.
