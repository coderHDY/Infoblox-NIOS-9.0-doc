...
3. Save the configuration and click **Restart** if it appears at the top of the screen.
4. For information about viewing current leases, see *[Viewing Current Leases](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/managing-leases/viewing-current-leases)*[*.*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/managing-leases/viewing-current-leases)
