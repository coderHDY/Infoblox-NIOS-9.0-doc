...
- Define custom options in the predefined DHCPv6 option space or add options to an option space that you configured. For more information, see Configuring Custom DHCP Options below[.](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/about-ipv4-dhcp-options/About+IPv4+DHCP+Options#bookmark2268)
...
After you create an option space and add options to it, you can apply the options as described in *[Applying DHCP Options](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/about-ipv4-dhcp-options)*.
...
3. In the *Option* *Space* editor, click the Add icon to add a custom option. In the new row, complete the following:
   ...
   - **Type**: Select the option type (such as ipv6-address, text, boolean, and string as described in [*DHCP Option Data Types*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/about-ipv4-dhcp-options)[ ](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/about-ipv4-dhcp-options)table).  
...
DHCPv6 options support the same data types as DHCP IPv4 options. For more information about the data types, see* *[*DHCP Option Data Types*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/about-ipv4-dhcp-options)*.* To apply DHCP options:
