...
- To define the MAC address filters for each range, see *[Defining MAC Address Filters](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-filters/configuring-mac-address-filters)*.
- To bind each filter to the appropriate DHCP range, see *[Applying Filters to DHCP Objects](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-filters/applying-filters-to-dhcp-objects)*.
- To specify the DNS server IP address for the quarantine range and set the lease time to 30 seconds, see *[Configuring General IPv4 DHCP Properties](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-properties/configuring-general-ipv4-dhcp-properties)*.
