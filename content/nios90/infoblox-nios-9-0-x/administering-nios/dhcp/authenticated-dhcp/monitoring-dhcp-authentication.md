...
pageId: "280761306"
---
You can monitor the status of the captive portal service, as described in [*Monitoring Services*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-the-appliance/monitoring-services). You can check its status in the *Infoblox* *Grid* *Status* widget and the *Member* *Status* widget on the Dashboard. For information about these widgets, see [*Dashboards*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/dashboards).  
You can also view the MAC addresses that were added to each MAC address filter, as described in [*Viewing MAC Address Filter Items*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-filters/managing-dhcp-filters).
...
For more information about the filters and editing their properties, see [*Managing DHCP Filters*](/nios90/infoblox-nios-9-0-x/administering-nios/dhcp/configuring-dhcp-filters/managing-dhcp-filters).  
