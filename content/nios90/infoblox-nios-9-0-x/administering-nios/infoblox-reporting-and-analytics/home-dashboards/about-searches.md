...
| --- | --- |
| Inactive IP Addresses, for more information see [*Devices (Discovery) Dashboards*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/predefined-dashboards/devices-discovery-dashboards). | Network view + IP address |
| For more information about these dashboards, see [*IPAMv4 Utilization Dashboards*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/predefined-dashboards/ipamv4-utilization-dashboards). |
