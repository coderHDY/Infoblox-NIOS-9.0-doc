...
- Monitor the license volume usage on the reporting server regularly using the following dashboards:
  ...
  - Monitor the **Today's License Usage** (GB) and **License Usage Trend Per Member** panels available in the [*Home Dashboards*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/home-dashboards).
  - For more information about the the following, see [*Internal Dashboards*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/predefined-dashboards/internal-dashboards)[:](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/predefined-dashboards/internal-dashboards)
