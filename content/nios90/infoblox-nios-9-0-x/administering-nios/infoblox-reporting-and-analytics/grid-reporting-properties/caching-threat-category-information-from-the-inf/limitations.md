...
- When the threat indicator caching feature is enabled, threat details in the *DNS Top RPZ Hits* report does not show historic data. For more information about the *DNS Top RPZ Hits* report, see [*Security Dashboards*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-reporting-and-analytics/predefined-dashboards/security-dashboards).
