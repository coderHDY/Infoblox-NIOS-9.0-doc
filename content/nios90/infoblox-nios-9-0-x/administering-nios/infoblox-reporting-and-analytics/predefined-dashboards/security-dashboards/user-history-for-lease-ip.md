...
- **User Status**: Displays the status of the user. This can be one of the following: **Active** (logged in), **Logged** **Out**, **Timed** **Out**.
  ...
  - **Timed** **Out**: The user is logged in but has been idled for a certain period of time. The default is two hours. You can configure this time interval, as described in Configuring Active User Timeout Session, see [*Viewing Identity Mapping Information*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/managing-ip-addresses/viewing-identity-mapping-information).
