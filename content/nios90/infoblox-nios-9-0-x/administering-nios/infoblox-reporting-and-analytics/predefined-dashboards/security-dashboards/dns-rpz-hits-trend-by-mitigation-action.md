...
- **Block**: Total number of queries that triggered a **Block** **(No** **Data)** and **Block** **(No** **Such** **Domain)** RPZ rule. For information about managing **Block** **(No** **Data)** and **Block** **(No** **Such** **Domain)** RPZ rules, see [*Configuring Rules for RPZs*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-infrastructure-security/infoblox-dns-firewall/configuring-rules-for-rpzs) respectively.
- **Passthru**: Total number of queries that triggered the **Passthru** RPZ rule. For information about managing **Passthru** RPZ rule, see [*Configuring Rules for RPZs*](/nios90/infoblox-nios-9-0-x/administering-nios/infoblox-infrastructure-security/infoblox-dns-firewall/configuring-rules-for-rpzs).
