...
source: "/space/nios90/1356857674"
pageId: "1356857674"
---
...
3. Complete the following:
   ...
   - Select **Classic Dashboards** or **Dashboard Studio **and choose **Absolute or Grid layout to create a dashboard in Dashboard Studio.**  
     ...
     Dashboard Studio type of dashboards are new type of dashboards available with latest version of Splunk. For details on Splunk Dashboard Studio, please refer [*https://docs.splunk.com/Documentation/Splunk/9.2.1/DashStudio/IntroFrame*](https://docs.splunk.com/Documentation/Splunk/9.2.1/DashStudio/IntroFrame)**.**
4. Click **Create**.
