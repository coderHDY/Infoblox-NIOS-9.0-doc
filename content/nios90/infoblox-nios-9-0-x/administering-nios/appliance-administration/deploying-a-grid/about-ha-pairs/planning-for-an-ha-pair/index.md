...
> - You can enable ARP on the passive node of an HA pair and monitor its status externally. To enable ARP on the passive node of an HA pair, see [*Enabling ARP on the Passive Node of an HA Pair*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/deploying-a-grid/about-ha-pairs/planning-for-an-ha-pair/enabling-arp-on-the-passive-node-of-an-ha-pair).
