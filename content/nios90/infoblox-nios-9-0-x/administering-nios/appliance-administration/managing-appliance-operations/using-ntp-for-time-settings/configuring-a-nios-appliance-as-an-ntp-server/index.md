...
- Optionally, configure anycast addressing for DNS and use the anycast IP address for NTP requests. For information about how to configure DNS anycast, see [*Configuring Anycast Addresses*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-ip-routing-options/configuring-anycast-addresses).
