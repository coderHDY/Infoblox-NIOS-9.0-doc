...
pageId: "280273950"
---
Whenever you make a change such as adding a zone or a network, Grid Manager notifies you that a service restart is required. You can enable the appliance to display the **Restart** **Banner** whenever it requires a service restart and prompt the administrator to input the user name before restarting the services. For information about how to enable the restart banner, see [*Changing Grid Properties*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/deploying-a-grid/managing-a-grid). To view all pending activities that are waiting for service restart s , you can click **View** **Changes** in the restart banner at the top of Grid Manager.  
