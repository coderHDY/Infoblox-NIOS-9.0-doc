...
> **Note**
> 
> - You can set the DSCP value of the primary LAN using the [*set network*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/set-commands/set-network) CLI command. DSCP values for all other interfaces and VLANs must be set through Grid Manager.
> - You can set the DSCP value for a Grid or an individual member from the Grid Manager UI, as detailed in [*Configuring the DSCP Value*](/nios90/by-id/1327464518)*,* or you can set it using the [*set dscp*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/set-commands/set-dscp) CLI command.
