...
| Reporting | Yes, for more information Reports for IB-FLEX, see [*About IB-FLEX*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/about-ib-flex)*.* | Yes |
| VLAN | Yes | Yes |
| DSCP | Yes | Yes |
| Sort list | Yes | Yes |
...
| CLI commands | You can use the commands `set dns-accel` and `show dns-accel` to view and set DNS cache acceleration information. For more information, see [*CLI Commands*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/cli-commands). | You can use the commands `set dns-accel` and `show dns-accel` to view and set DNS cache acceleration information. For more information, see [*CLI Commands*](/nios90/infoblox-nios-9-0-x/using-the-nios-cli/cli-commands). |
...
| Reporting | Yes, for more information Reports for IB-FLEX, see [*About IB-FLEX*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/about-ib-flex)*.* | No | No | No | Yes | Yes |
| VLAN | Yes | Yes |
| DSCP | Yes | Yes |  |  |  |  |
| Sort list | Yes | Yes |  |  |  |  |
| Anycast (OSPF and BGP) | Yes | Yes |  |  |  |  |
