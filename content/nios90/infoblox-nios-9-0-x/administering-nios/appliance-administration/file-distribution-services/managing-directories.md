...
3. The *Directory* editor provides the following tabs from which you can modify data:
   ...
   - **Permissions**: You can add or delete admin permissions in this tab. For information, see [*About Administrative Permissions*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/about-administrative-permissions).
