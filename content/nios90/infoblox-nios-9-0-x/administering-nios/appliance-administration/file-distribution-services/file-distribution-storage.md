...
- When the Grid member storage capacity reaches 100%, the SNMP trap generates a "High Usage" message. For information on how to modify the threshold values, see [*Configuring SNMP*](/nios90/infoblox-nios-9-0-x/administering-nios/monitoring/monitoring-with-snmp/configuring-snmp).
