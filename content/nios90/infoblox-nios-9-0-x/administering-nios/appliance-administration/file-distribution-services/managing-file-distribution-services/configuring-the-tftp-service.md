...
The TFTP service is supported only on LAN1 and MGMT interfaces. For more information, see [*Configuring Ethernet Ports*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/configuring-ethernet-ports).
