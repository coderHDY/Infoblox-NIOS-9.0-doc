---
title: "Viewing Admin Roles"
source: "/space/nios90/1395655183"
pageId: "1395655183"
---
...
- Create a quick filter to save frequently used filter criteria. For information about using quick filters, see [*Finding and Restoring Data*](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/performing-basic-operations-using-grid-manager/finding-and-restoring-data)[.](/nios90/infoblox-nios-9-0-x/using-the-grid-manager-interface/performing-basic-operations-using-grid-manager/finding-and-restoring-data)
