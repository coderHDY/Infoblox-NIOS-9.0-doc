...
3. Click the **Override **button if you want to override the disable setting that you [*specified for the Grid*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-security-operations/Managing+Security+Operations#ConfiguringSecurityFeatures).
