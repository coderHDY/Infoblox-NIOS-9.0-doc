...
- Configure one or more AD authentication server group on the appliance and add AD domain controllers to the group. For information about configuring an AD authentication service group for admins, see [*Configuring an Active Directory Authentication Service Group*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/authenticating-admins-using-active-directory/configuring-an-active-directory-authentication-s).
...
- Add the newly configured Active Directory service to the list of authentication services in the admin policy, and add the admin group names as well. For more information about configuring an admin policy, see [*Defining the Authentication Policy*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/defining-the-authentication-policy).
