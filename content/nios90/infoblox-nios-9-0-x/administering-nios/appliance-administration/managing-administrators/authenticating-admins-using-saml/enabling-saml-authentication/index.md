...
4. In the *Add SAML Authentication Service* wizard:
   ...
   - **SSO Metadata URL**: Enter the metadata URL of the IdP. Alternatively, copy the metadata into a file and upload the file. For information on obtaining the metadata, see [*Obtaining Metadata*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/authenticating-admins-using-saml/enabling-saml-authentication/obtaining-metadata).
