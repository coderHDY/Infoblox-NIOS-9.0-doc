...
- If a user has logged in to the IdP account and the corresponding IdP account is not present in NIOS, if the **Auto Create User** checkbox is selected, the user can directly start using Grid Manager without logging in to NIOS. For information about the **Auto Create User** checkbox, see [*Auto Creating SAML Users in NIOS*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/authenticating-admins-using-saml/auto-creating-saml-users-in-nios).
