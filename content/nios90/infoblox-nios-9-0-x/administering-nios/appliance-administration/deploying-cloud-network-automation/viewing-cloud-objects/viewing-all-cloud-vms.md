...
- **Red**: Discovered VMs that have at least one associated NIOS object and there is conflicting information between the discovered data and the NIOS data. Depending on the nature of the conflict, you can resolve them as described in [*Resolving Conflicting Addresses*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/ip-discovery-and-vdiscovery/managing-discovered-data/resolving-conflicting-addresses).You may also be able to convert or clear unmanaged data, as described in [*Managing Unmanaged Data*](/nios90/infoblox-nios-9-0-x/administering-nios/ip-address-management/ip-discovery-and-vdiscovery/managing-discovered-data/managing-unmanaged-data)*.*
