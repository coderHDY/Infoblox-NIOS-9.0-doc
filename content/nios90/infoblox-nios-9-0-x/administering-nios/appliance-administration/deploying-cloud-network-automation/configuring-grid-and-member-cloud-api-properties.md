...
pageId: "280407427"
---
Only admin users in admin groups with cloud API access can be used to send cloud API queries by default. For information about how to add users to an admin group, see [*Creating Local Admins*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-administrators/creating-local-admins). To control which admin users, either from this group or from remote servers, can perform cloud API tasks, you can further define ACLs at the Grid and member levels.
