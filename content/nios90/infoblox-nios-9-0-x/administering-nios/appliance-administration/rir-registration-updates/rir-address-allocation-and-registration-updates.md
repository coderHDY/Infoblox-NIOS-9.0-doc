...
The NIOS appliance supports submitting registration and reassignment updates to the RIPE database, which can be accessed through the RIPE API interface or an email template. For more information, see [Configuring RIR Communication Settings](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/rir-registration-updates/configuring-rir-registration-updates/Configuring+RIR+Registration+Updates#Configuring RIR Communication Settings).
