---
title: "Rescheduling Tasks Associated With Objects"
source: "/space/nios90/1454965089"
pageId: "1454965089"
---
...
1. From the **Administration** tab, select the **Workflow** tab -&gt; **Task Manager** tab -&gt; *scheduled_task* checkbox, and then click the Reschedule icon.
...
3. **For modification**: In the editor, click the Schedule icon at the top of the editor. In the *Schedule Change* panel, modify the date, time, and time zone. You can also select **Now** to execute the task upon saving the entry.   
   **For deletion**: In the *ScheduleDeletio*n dialog box, modify the date, time, and time zone. You can also select **Delete Now** to delete the object upon clicking **Delete Now**. The appliance puts the deleted object in the Recycle Bin, if enabled.
