---
title: "Manually Allocating Dynamic Licenses"
source: "/space/nios90/1495401013"
pageId: "1495401013"
---
To allocate a particular feature license to a NIOS member:

1. From the **Infoblox Grid** tab, select the **Licenses** tab -&gt; **Pool** tab.
2. Select the feature license and click the Action icon <sup> </sup>next to the license, and then select **Allocate** from the list.
