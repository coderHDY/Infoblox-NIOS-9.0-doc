...
Infoblox stores Grid-wide license information in a license file. To install Grid-wide licenses, upload the entire license file to the Grid Master, as described in the [*Installing Licenses*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/managing-licenses-in-nios-9-0-1-and-later/installing-licenses) section.
...
- Create a Grid as a host by associating the license UID of the Grid Master:
  ...
  8. Click **Assign Software** to assign the licenses.  
     ...
     ![Software_to_assign.png](/assets/2341830667/33092fe6-66fd-4066-a738-47c333ef137f.png)
