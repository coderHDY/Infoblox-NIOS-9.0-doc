...
- For the LAN1 port, see [*Modifying Ethernet Port Settings*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/configuring-ethernet-ports/modifying-ethernet-port-settings).
- For the LAN2 port, see [*Using the Lan2 Port*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/using-the-lan2-port).
- For the MGMT port, see [*Using The MGM Port*](/nios90/infoblox-nios-9-0-x/administering-nios/appliance-administration/managing-appliance-operations/using-the-mgmt-port).
