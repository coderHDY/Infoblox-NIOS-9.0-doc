...
pageId: "280408834"
---
You can download a DNS Infrastructure Protection ruleset any time when you select to manually perform ruleset updates. You can choose to download rule updates but not immediately deploy them. NIOS archives and tracks up to nine ruleset versions, allowing for switching and merging between these versions when necessary. After uploading a ruleset, you can apply it by publishing it to the Grid and individual members. For more information, see *[Publishing Rule Updates](/nios90/by-id/280408857)*.  
