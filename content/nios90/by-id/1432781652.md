---
title: "Configuring an IPv4 Reverse-Mapping Stub Zone"
source: "/space/nios90/1432781652"
pageId: "1432781652"
---
...
5. Click **Next** to specify a stub member NS group or define the name servers individually to serve the reverse-mapping stub zone. Select one of the following:
   ...
   - Select **Use** ** this ** **name** ** server ** **group** to assign a stub member NS group for the zone. You can select the forward/stub server NS group from the drop-down list. For information about stub member NS group, see [*Using Stub Member Name Server Groups*](/nios90/infoblox-nios-9-0-x/administering-nios/dns/configuring-dns-zones/using-name-server-groups).
