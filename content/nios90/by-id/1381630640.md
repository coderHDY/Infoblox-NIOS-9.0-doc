...
You cannot modify the assigned network view or DNS view of a Microsoft server after its data has been synchronized. Instead, you must remove the Microsoft server and then add it again. For information about removing a server, see [*Removing a Managed Microsoft Server*](/nios90/infoblox-nios-9-0-x/administering-nios/configuring-microsoft-windows-servers/managing-microsoft-windows-servers/managing-microsoft-servers/Managing+Microsoft+Servers#Removing-a-Managed-Microsoft-Server).
