---
title: "Defining Substitute Rules for HTTPS Records"
source: "/space/nios90/1584037939"
pageId: "1584037939"
---
An HTTPS record is a DNS resource record that maps a domain name to a service endpoint. To define a specific name-to-service mapping, you can add an HTTPS record to a previously defined authoritative forward-mapping zone.

Complete the following to add an HTTPS record:
...
- **Select Zone**: Click to select a zone. You can select a signed zone or an unsigned zone to associate with an HTTPS resource record. Click Clear to clear the Name that you have entered.
